...
mod tests {
    ...
    #[rstest]
    #[case::correct_values(Color::new_color(1.0, 0.0, 0.0).clamp(), Color::new_color(1.0, 0.0, 0.0))]
    #[case::correct_values2(Color::new_color(0.0, 0.0, 0.0).clamp(), Color::new_color(0.0, 0.0, 0.0))]
    #[case::bigger_values(Color::new_color(0.0, 10.0, 0.0).clamp(), Color::new_color(0.0, 1.0, 0.0))]
    #[case::negative_values(Color::new_color(0.0, 0.0, -10.0).clamp(), Color::new_color(0.0, 0.0, 0.0))]
